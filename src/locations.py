        ...
        def stem_last(ner):
            ...
            if len(ner) == 1:
                if ner[0] in word_lemma:
                    ...
                    ner[0].lower().endswith("-ban")
                    or ner[0].lower().endswith("-ben")
                    or ner[0].lower().endswith("-nak")
                    or ner[0].lower().endswith("-nek")
                    or ner[0].lower().endswith("-on")
                    or ner[0].lower().endswith("-en")
                    or ner[0].lower().endswith("-ön")
                    or ner[0].lower().endswith("-t")
                ):
